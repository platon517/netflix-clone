      ...
      <nav>
        ...
        <div className="nav-bar"  id="nav-bar">
          <div onClick={this.to_nav} className="nav-bar__wrapper">
            <label onClick={()=>{this.changeTab(1)}} htmlFor="hiddenRad1" className="nav-bar__button" id="nav-bar__button1">
            ...
            <label  onClick={()=>{this.changeTab(2)}} htmlFor="hiddenRad2" className="nav-bar__button" id="nav-bar__button2">
              <div className="nav-bar__button__icon">
                <svg viewBox="0 0 145 48" id="icon-cross-device-screens-desktop" width="100%" height="100%">
            ...
            <label  onClick={()=>{this.changeTab(3)}} htmlFor="hiddenRad3" className="nav-bar__button" id="nav-bar__button3">
              <div className="nav-bar__button__icon">
